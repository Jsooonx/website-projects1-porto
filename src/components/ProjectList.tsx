          ...
          {projectsData.map((project) => (
            <motion.div key={project.id} variants={itemVariants} className="w-full flex">
              ...
              >
                ...
                <div className={`relative w-full aspect-[4/3] rounded-b-2xl overflow-hidden flex items-center justify-center flex-grow ${['scholarhub', 'warungify'].includes(project.id) ? 'bg-[#fcfcfb]' : 'bg-neutral-950'}`}>
                  <img 
